...
---
*Please report any issues on [GitHub Issues](https://github.com/Alex-Nemet/ncSender/issues)*"
...
echo "CI pipeline will build the beta release at: https://github.com/Alex-Nemet/ncSender/actions"
